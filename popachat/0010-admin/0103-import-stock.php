...
echo "Import Stock chosen<br>";
 ...
 echo "La date est $thedate";
$array=import_xls($target_file,$try); // get imports
//------------------------------------------------------------------
// defines column to import
$colMatch=['ean'=>'A','refFour'=>'B','designation'=>'C','prixAchat'=>'F','stock'=>'D','departement'=>'M','famille'=>'O'];
$dico=importXlsArrayToDictionnary($array,$colMatch);  // load Excel

// Variable to load stock
echo "<br>the Stock<br>";
$primary="id";
...
//---------------------------------------------------------------------
// Update Departement and Famille
echo "<br>the departement</br>";
$primary="ean";
$tableName="prod_articles";
$filter=['ean','departement','famille'];
